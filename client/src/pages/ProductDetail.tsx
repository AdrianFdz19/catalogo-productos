...
const ProductDetail: React.FC = () => {
  ...
  useEffect(() => {
    if (product && typeof product.isFavorite === 'boolean') {
              ...
              {user?.role === 'admin' && (
                <>
                  <button
                    ...
                    className="flex items-center justify-center gap-2 border border-gray-400 text-gray-800 font-medium py-2 rounded-lg hover:bg-gray-100 transition"
                  >
                    ✏️ Editar producto
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 border border-red-500 text-red-600 font-medium py-2 rounded-lg hover:bg-red-600 hover:text-white transition"
                  >
                    🗑️ Eliminar producto
                  </button>
                </>
